  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', border: '1px solid #E2E8F0', borderRadius: '10px', overflow: 'hidden' }}>
        {[{ l: '전체', v: complaints.length }, { l: '처리중', v: proc }, { l: '해결완료', v: done }, { l: '보류/거절', v: hold }].map((s, i) => (
      ...
      <div>
        ...
        {complaints.map(c => (
          <div key={c.id} style={{ padding: '16px 2px', borderBottom: '1px solid #F1F5F9', display: 'flex', alignItems: 'center', gap: '14px', cursor: 'pointer' }}>
